...
S6 green identity commit `2aad71532735b973c37e3a91085c7a492218a4d3` makes the build-6720 `@me` probe pass through the private `PullRequestSource` seam and stable `login` filtering. Pagination red commit `887ca735548b66a6cef6a4f887a778b049d90ca2` freezes six focused failures for page 2, terminal pages, default and explicit limits, the 1,000-candidate cap, and later-page errors without partial data; the identity/head control passes. Both commits are pushed at `0/0` parity. The coordinator remains the sole writer and PR #29 remains the sole external integration PR.
